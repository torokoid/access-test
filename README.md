...
<h3><span class="yellow">YAESUのハンディー機がACアダプターで充電しながらの送信ができない様なので、<br>メーカーにメールで問い合わせしました。<br>結論は送信には未対応、オプションを使えば送信可能とのことでした。</span></h3>
<a href="20210831_013.png" data-lightbox="abc"><img src="20210831_013.png" alt="サンプル画像" width="900" /></a>	
<h3><span class="white">さらに、シガーライター電源のケースに何か回路が入っているのか？問い合わせました。</span></h3>
